...
import sys
sys.path.append('/data/hxyz/Hawkes/')
...
if __name__ == '__main__':
    ...
    domain_names = {'seq_id': 'id',
                    'time': 'time',
                    'event': 'event'}
    database = load_sequences_csv('{}/{}/zz1000_100.csv'.format(util.POPPY_PATH, util.DATA_DIR),
    ...
    domain_dict = {'time': 'numerical',
                   'option1': 'categorical'}
    database = load_seq_features_csv('{}/{}/zz1000_100.csv'.format(util.POPPY_PATH, util.DATA_DIR),
                                     seq_domain='id',
    ...
    database = load_event_features_csv('{}/{}/zz1000_100.csv'.format(util.POPPY_PATH, util.DATA_DIR),
                                       event_domain='event',
                                       domain_dict=domain_dict,
                                       database=database,
                                       normalize=1)
    ...
    hawkes_model.plot_causality(all_events,
                                output_name='{}/{}/causality_zz1000.png'.format(util.POPPY_PATH, util.OUTPUT_DIR))
